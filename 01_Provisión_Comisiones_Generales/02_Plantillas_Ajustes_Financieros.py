...
generales_ajustes = fimptrans.lectura_ajustes(mes_cierre,año_cierre,cabecera_anterior_completo)

#### 3) Generar Plantillas de Ajustes Financieros

# Función para generar plantillas de ajustes financieros
fplantajust.plantillas_ajustes(generales_ajustes,ultimo_dia_del_mes,mes_cierre,año_cierre)

#### 4) Generar Plantillas de Ajustes Financieros USD

# Función para generar plantillas de ajustes financieros en USD
fplantajustusd.plantillas_ajustes_usd(generales_ajustes,ultimo_dia_del_mes,mes_cierre,año_cierre)